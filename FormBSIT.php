...
<head>
  ...
  <script src="css/formbsit.js"></script>
</head>
<?php
...
<body>
  <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    <table>
      ...
      <tr>
        <td>Year 4</td>
        <td><input type='number' step='0.01' name='first_sem_avg_4' id='first_sem_avg_4' required></td>
        <td><input type='number' step='0.01' name='second_sem_avg_4' id='second_sem_avg_4' required></td>
      </tr>
    </table>
  ...
  if (isset($_POST['compute'])) {
    ...
    $yr_4_final_ave_hidden = $yr_4_final_ave;
    ...
    try {
      ...
      $stmt = $conn->prepare("INSERT INTO student_grades (studentnumber1,first_sem_avg_1, first_sem_avg_2, first_sem_avg_3, first_sem_avg_4, second_sem_avg_1, second_sem_avg_2, second_sem_avg_3, second_sem_avg_4, summer_avg, yr_1_final_ave, yr_2_final_ave, yr_3_final_ave, yr_4_final_ave, final_average, academicDistinction) 
  VALUES (:student_Number1,:firstSemAvg1, :firstSemAvg2, :firstSemAvg3, :firstSemAvg4, :secondSemAvg1, :secondSemAvg2, :secondSemAvg3, :secondSemAvg4, :summerAvg, :yr1FinalAve, :yr2FinalAve, :yr3FinalAve, :yr4FinalAve, :finalAverage, :academicDistinction)");
      ...
      $stmt->bindParam(':firstSemAvg4', $firstSemAverages[3]);
      ...
      $stmt->bindParam(':secondSemAvg4', $secondSemAverages[3]);
      ...
      $stmt->bindParam(':yr4FinalAve', $yr_4_final_ave);
